...
<div style="padding:10px 10px 10px 10px">
    <form id="contentAddForm" class="itemForm" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>内容描述:</td>
                <td><input class="easyui-textbox" name="titleDesc" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;"/></td>
            </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        contentAddEditor = E3.createEditor("#contentAddForm [name=content]"); // 初始化富文本编辑器
        E3.initOnePicUpload();  // 图片上传控件
